...
def informe_rangos_cinturon_por_alumno(alumno_id):
    alumno = collection_alumnos.find_one({"_id": alumno_id}, {"cinturones": 1, "nombre": 1})
    return alumno

# Ejemplo de uso
alumno_id = 1
print(informe_rangos_cinturon_por_alumno(alumno_id))
